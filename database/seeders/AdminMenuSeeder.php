...
class AdminMenuSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $menus = [
            ...
            ['title' => 'Banner',            'url' => 'admin/banners',      'icon' => 'bi bi-card-image',    'order' => 9,  'type' => 'menu', 'roles_allowed' => ['superadmin', 'admin']],
            ...
            ['title' => 'SEO Management',    'url' => 'admin/seo',          'icon' => 'bi bi-search',        'order' => 12, 'type' => 'menu', 'roles_allowed' => ['superadmin', 'admin', 'markom']],
            ['title' => 'Analytics',         'url' => 'admin/traffic',      'icon' => 'bi bi-bar-chart-line','order' => 13, 'type' => 'menu', 'roles_allowed' => ['superadmin', 'admin', 'markom']],
            ['title' => 'Pengaturan',        'url' => 'admin/settings',     'icon' => 'bi bi-gear',          'order' => 14, 'type' => 'menu', 'roles_allowed' => ['superadmin']],
            ['title' => 'Teks Halaman',      'url' => 'admin/translations', 'icon' => 'bi bi-translate',     'order' => 15, 'type' => 'menu', 'roles_allowed' => ['superadmin']],
            ['title' => 'Manajemen Menu',    'url' => 'admin/menus',        'icon' => 'bi bi-list-nested',   'order' => 16, 'type' => 'menu', 'roles_allowed' => ['superadmin']],
            ['title' => 'Manajemen User',    'url' => 'admin/users',        'icon' => 'bi bi-people',        'order' => 17, 'type' => 'menu', 'roles_allowed' => ['superadmin']],
        ];
