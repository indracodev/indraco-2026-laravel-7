...
@section('content')
<main id="konten">
    <h1 class="visually-hidden" data-i18n="business_h1">{{ __('business_h1') }}</h1>
    <div class="container">
        <!-- Section: Ekspor -->
        <section class="py-5">
            <div class="py-lg-5">
                <h2 class="display-4 fw-thin text-capitalize" data-i18n="ekspor_title">{!! __('ekspor_title') !!}</h2>
                <p class="lead mb-5" data-i18n="ekspor_desc">{{ __('ekspor_desc') }}</p>
                <div class="d-flex gap-3 align-items-center">
                    ...
                    <ul class="mb-0">
                        <li data-i18n="ekspor_list1">{{ __('ekspor_list1') }}</li>
                        <li data-i18n="ekspor_list2">{{ __('ekspor_list2') }}</li>
                        <li data-i18n="ekspor_list3">{{ __('ekspor_list3') }}</li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="py-5">
            <div class="py-lg-5">
                <h2 class="display-4 fw-thin text-capitalize" data-i18n="packaging_title">{!! __('packaging_title') !!}</h2>
                <p class="lead mb-5" data-i18n="packaging_desc">{{ __('packaging_desc') }}</p>
                <div class="d-flex gap-3 align-items-center">
                    ...
                    <ul class="mb-0">
                        <li data-i18n="packaging_list1">{{ __('packaging_list1') }}</li>
                        <li data-i18n="packaging_list2">{{ __('packaging_list2') }}</li>
                        <li data-i18n="packaging_list3">{{ __('packaging_list3') }}</li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="py-5">
            <div class="py-lg-5">
                <h2 class="display-4 fw-thin text-capitalize" data-i18n="business_dist_title">{!! __('business_dist_title') !!}</h2>
                <p class="lead mb-5" data-i18n="business_dist_desc">{{ __('business_dist_desc') }}</p>
                <ul class="list-unstyled mb-0 row row-gap-5 gx-lg-5">
                    <li class="col col-12 col-lg-6 pe-xl-5">
                        <article>
                            ...
                            <h3 class="fw-bold fs-4 text-capitalize my-3" data-i18n="business_domestic_title">{{ __('business_domestic_title') }}</h3>
                            <p data-i18n="business_domestic_desc">{{ __('business_domestic_desc') }}</p>
                        </article>
                    </li>
                    <li class="col col-12 col-lg-6 pe-xl-5 ps-xl-5">
                        <article>
                            ...
                            <h3 class="fw-bold fs-4 text-capitalize my-3" data-i18n="business_international_title">{{ __('business_international_title') }}</h3>
                            <p data-i18n="business_international_desc">{{ __('business_international_desc') }}</p>
                        </article>
                    </li>
                </ul>
            </div>
        ...
        <section class="py-5">
            <div class="py-lg-5">
                <h2 class="display-4 fw-thin text-capitalize" data-i18n="business_online_title">{!! __('business_online_title') !!}</h2>
                <p class="lead mb-5" data-i18n="business_online_desc">{{ __('business_online_desc') }}</p>
                <ul class="list-unstyled mb-0 row row-gap-5 gx-lg-5">
                    <li class="col col-12 col-lg-6 pe-xl-5">
                        <article>
                            ...
                            <h3 class="fw-bold fs-4 text-capitalize my-3" data-i18n="business_ecommerce_title">{{ __('business_ecommerce_title') }}</h3>
                            <p class="mb-4" data-i18n="business_ecommerce_desc">{{ __('business_ecommerce_desc') }}</p>
                    ...
                    <li class="col col-12 col-lg-6 pe-xl-5 ps-xl-5">
                        <article>
                            ...
                            <h3 class="fw-bold fs-4 text-capitalize my-3" data-i18n="business_marketplace_title">{{ __('business_marketplace_title') }}</h3>
                            <p class="mb-4" data-i18n="business_marketplace_desc">{{ __('business_marketplace_desc') }}</p>
