...
@section('content')
   <section aria-labelledby="hero-banner-title">
      <div class="hero-banner position-relative overflow-hidden bg-secondary">
         ...
         @if (($banner_type ?? 'youtube') === 'youtube' && !empty($banner_value))
            ...
            <video class="videotron position-absolute top-50 start-50 translate-middle" style="aspect-ratio: 16/9;"
               width="1600" height="900" loop="" muted="" preload="none" playsinline="true"
               aria-label="Indraco homepage loop" aria-describedby="video-description-Indonesiaidhomepageloop"
               autoplay="true">
               <source src="{{ asset('images/home_banner.mp4') }}">
            </video>
         ...
         <div class="z-1 video-overlay position-absolute bg-black opacity-50" style="inset: 0; pointer-events: none;">
         </div>
         <div class="banner-caption z-2 position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center p-4">
            <div class="container">
               <div class="text-white" style="max-width: 660px;">
                  <h1 id="hero-banner-title" class="display-5 fw-bold text-start" data-i18n="home_banner_title">
                     {{ __('home_banner_title') }}</h1>
                  <p class="lead mb-4" data-i18n="home_banner_text">{{ __('home_banner_text') }}</p>
                  <a href="{{ route('about') }}" class="btn btn-outline-invert text-capitalize"
                     data-i18n="learn_more">{{ __('learn_more') }}</a>
               </div>
            </div>
         </div>
      </div>
   ...
   <div class="container">
               ...
               <div class="col col-12 col-md-auto">
                  <div class="card p-4 bg-light-subtle rounded-4 border-0 d-flex flex-column"
                     ...
                     <div class="flex-grow-1">
                        <h3 class="fw-thin text-capitalize w-75" style="font-size: 2.25rem;" data-i18n="home_2">
                           {{ __('home_2') }}</h3>
                     </div>
                     <form id="formNewsletter">
                        ...
                        <div class="input-group border-bottom border-light">
                           <input type="email" name="email"
                              class="form-control rounded-0 px-0 border-0 bg-transparent text-reset" placeholder="Email"
                              required>
      ...
      <section class="py-5">
         <div class="py-lg-5">
            <h2 class="fs-3 fw-bold mb-4 text-capitalize" data-i18n="home_3">{{ __('home_3') }}</h2>
            <div class="row row-cols-1 row-cols-sm-2 row-cols-xl-3 g-3 g-sm-4 g-md-5">
               <div class="col">
                  <article class="card bg-light-subtle rounded-4 border-0 h-100">
                     <div class="card-body p-5">
                        <img src="{{ asset('images/landing-icon-distribution.png') }}" alt=""
                           aria-hidden="true" loading="lazy"
                           style="aspect-ratio: 1/1; width: 30%; object-fit: contain;">
                        <h3 class="card-title fs-5 fw-bold text-capitalize my-3" data-i18n="home_4">{{ __('home_4') }}
                        </h3>
                        <p class="card-text" data-i18n="home_5">{{ __('home_5') }}</p>
                     </div>
                  </article>
               </div>
               <div class="col">
                  <article class="card bg-light-subtle rounded-4 border-0 h-100">
                     <div class="card-body p-5">
                        <img src="{{ asset('images/landing-icon-market.png') }}" alt="" aria-hidden="true"
                           loading="lazy" style="aspect-ratio: 1/1; width: 30%; object-fit: contain;">
                        <h3 class="card-title fs-5 fw-bold text-capitalize my-3" data-i18n="home_6">{{ __('home_6') }}
                        </h3>
                        <p class="card-text" data-i18n="home_7">{{ __('home_7') }}</p>
                     </div>
                  </article>
               </div>
               <div class="col">
                  <article class="card bg-light-subtle rounded-4 border-0 h-100">
                     <div class="card-body p-5">
                        <img src="{{ asset('images/landing-icon-F&B.png') }}" alt="" aria-hidden="true"
                           loading="lazy" style="aspect-ratio: 1/1; width: 30%; object-fit: contain;">
                        <h3 class="card-title fs-5 fw-bold text-capitalize my-3" data-i18n="home_8">{{ __('home_8') }}
                        </h3>
                        <p class="card-text" data-i18n="home_9">{{ __('home_9') }}</p>
                     </div>
                  </article>
               </div>
            </div>
            ...
            <div class="row row-gap-5 gx-md-5 align-items-md-center justify-content-md-between">
               <div class="col col-12 col-md-auto">
                  <div class="position-relative py-4 pe-5 d-inline-block">
                     <div class="bg-light-subtle rounded-4 position-absolute top-0 end-0 h-100 z-0"
                        style="aspect-ratio: 1/1;"></div>
                     <h2 class="display-1 lh-1 fw-thin text-uppercase text-nowrap z-1 position-relative"><span
                           data-i18n="home_10">{{ __('home_10') }}</span> <br> <span class="fw-medium small">1.000.000
                           +</span></h2>
                  </div>
                  <p class="fs-3 mb-0" data-i18n="home_11">{{ __('home_11') }}</p>
               </div>
               <div class="col col-12 col-md col-xl-6">
                  <p data-i18n="home_12">{{ __('home_12') }}</p>
                  <a href="{{ route('contact') }}" class="btn btn-outline-invert text-capitalize"
                     data-i18n="contact_us">{{ __('contact_us') }}</a>
               </div>
            </div>
         </div>
      </section>
         ...
         <div class="py-lg-5">
            <div class="row row-gap-5 gx-lg-5 align-items-lg-center justify-content-lg-between">
               <div class="col col-12 col-lg-auto order-lg-2">
                  <img src="{{ asset('images/cart-indracostore.png') }}" alt="" aria-hidden="true"
                     loading="lazy" class="w-100 h-auto" style="max-width: 450px;">
               </div>
               <div class="col col-12 col-lg col-xl-6 order-lg-1">
                  <p data-i18n="home_13">{{ __('home_13') }}</p>
                  <a href="https://www.indracostore.com/" target="_blank" class="btn btn-outline-invert text-capitalize"
                     data-i18n="buy_now">{{ __('buy_now') }}</a>
               </div>
            </div>
         </div>
      </section>
      ...
      <section class="py-5">
         <div class="py-lg-5 text-md-center">
            <h2 id="contact-title" class="fw-bold fs-3 mb-5 text-capitalize" data-i18n="contact_us">
               {{ __('contact_us') }}</h2>
            <address class="row row-cols-1 row-cols-sm-2 row-cols-xl-3 g-3 g-sm-4 g-md-5">
               <div class="col">
                  <article class="card bg-light-subtle rounded-4 border-0 h-100">
                     <div class="card-body p-5">
                        <img src="{{ asset('images/landing-icon-office.png') }}" alt="" aria-hidden="true"
                           loading="lazy" style="aspect-ratio: 1/1; width: 30%; object-fit: contain;">
                        <h3 class="card-title fs-5 fw-bold text-capitalize my-3" data-i18n="home_14">{{ __('home_14') }}
                        </h3>
                        <p class="card-text">
                           <a href="{{ $settings['contact_maps_link'] ?? 'https://maps.app.goo.gl/vLD5kH5WLryYcZwy6' }}"
                              target="_blank"
                              class="text-reset text-decoration-none opacity-75-hover">{{ $settings['contact_address'] ?? 'Jl. Semeru No. 133-135 Bambe, Kec. Driyorejo. Gresik 61177 Jawa Timur - Indonesia' }}</a>
                        </p>
                     </div>
                  </article>
               </div>
               <div class="col">
                  <article class="card bg-light-subtle rounded-4 border-0 h-100">
                     <div class="card-body p-5">
                        <img src="{{ asset('images/landing-icon-phone.png') }}" alt="" aria-hidden="true"
                           loading="lazy" style="aspect-ratio: 1/1; width: 30%; object-fit: contain;">
                        <h3 class="card-title fs-5 fw-bold text-capitalize my-3" data-i18n="home_15">{{ __('home_15') }}
                        </h3>
                        <p class="card-text text-start d-inline">
                           <b>T</b>. <a
                              href="tel:{{ str_replace(' ', '', $settings['contact_phone1'] ?? '+62 31 766 8777') }}"
                              target="_blank"
                              class="text-reset text-decoration-none opacity-75-hover">{{ $settings['contact_phone1'] ?? '+62 31 766 8777' }}</a>
                           <br>
                           <b>T</b>. <a
                              href="tel:{{ str_replace(' ', '', $settings['contact_phone2'] ?? '+62 31 766 7388') }}"
                              target="_blank"
                              class="text-reset text-decoration-none opacity-75-hover">{{ $settings['contact_phone2'] ?? '+62 31 766 7388' }}</a>
                           <br>
                           <b>F</b>. <a
                              href="fax:{{ str_replace(' ', '', $settings['contact_fax'] ?? '+62 31 766 9590') }}"
                              target="_blank"
                              class="text-reset text-decoration-none opacity-75-hover">{{ $settings['contact_fax'] ?? '+62 31 766 9590' }}</a>
                        </p>
                     </div>
                  </article>
               </div>
               <div class="col">
                  <article class="card bg-light-subtle rounded-4 border-0 h-100">
                     <div class="card-body p-5">
                        <img src="{{ asset('images/landing-icon-email.png') }}" alt="" aria-hidden="true"
                           loading="lazy" style="aspect-ratio: 1/1; width: 30%; object-fit: contain;">
                        <h3 class="card-title fs-5 fw-bold text-capitalize my-3">email</h3>
                        <p class="card-text">
                           <a href="{{ route('contact') }}"
                              class="text-reset text-decoration-none opacity-75-hover">{{ $settings['contact_email'] ?? 'info@indraco.com' }}</a>
                        </p>
                     </div>
                  </article>
               </div>
      ...
      <div class="modal-dialog modal-dialog-centered">
         <div class="modal-content text-light border-0 shadow" style="background-color: #595959; border-radius: 12px;">
            <div class="modal-body text-center py-5 position-relative">
               <button class="btn-close btn-close-white rounded-0 shadow-none position-absolute top-0 end-0 m-3"
                  data-bs-dismiss="modal" aria-label="Close"></button>
               <div class="container-fluid py-3">
                  <div class="row justify-content-center">
                     <div class="col-12 col-lg-10">
                        <h3 class="display-4 fw-light mb-4 text-white" data-i18n="subscribe_modal_title">
                           {{ __('subscribe_modal_title') }}</h3>
                        <p class="fs-5 mb-5 text-white" data-i18n="subscribe_modal_subtitle">
                           {{ __('subscribe_modal_subtitle') }}</p>
                        <p class="small mb-5 text-white-50 px-2" style="font-weight: 300;"
                           data-i18n="subscribe_modal_desc">{!! __('subscribe_modal_desc') !!}</p>
