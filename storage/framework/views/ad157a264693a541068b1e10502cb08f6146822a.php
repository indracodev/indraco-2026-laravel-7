<?php $__env->startSection('title', __('about_page_title')); ?>

<?php $__env->startSection('content'); ?>
<main id="konten" class="py-5">

    <h1 class="visually-hidden" data-i18n="about_1"><?php echo e(__('about_1')); ?></h1>
    ...
    <section class="section-content" aria-labelledby="about-title">
        <div class="section-header">
            <div class="container">
                <img src="<?php echo e(asset('images/about-us-sketch.png')); ?>" alt="Ilustrasi tentang perjalanan dan perkembangan INDRACO" loading="lazy" class="w-100 h-auto">
            </div>
        </div>
            ...
            <div class="container">
                <div class="section-caption">
                    <header class="d-flex gap-3 align-items-center mb-3">
                        <h2 id="about-title" class="caption-title mb-0 display-2 fw-bold text-capitalize" data-i18n="about_1"><?php echo e(__('about_1')); ?></h2>
                    </header>
                    <p data-i18n="about_2"><?php echo __('about_2'); ?></p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section-content" aria-labelledby="journey-<?php echo e($item['year']); ?>-title" data-section="timeline" data-year="<?php echo e($item['year']); ?>">
        <div class="section-header">
            <div class="container">
                <img src="<?php echo e(asset('images/' . $item['img'])); ?>" alt="Ilustrasi perjalanan INDRACO <?php echo e($item['year']); ?>" loading="lazy" class="w-100 h-auto">
            </div>
        </div>
        <div class="section-body">
            <div class="container">
                <div class="section-caption">
                    <header class="d-flex gap-3 align-items-center mb-3">
                        <h3 id="journey-<?php echo e($item['year']); ?>-title" class="caption-title mb-0 display-2 fw-bold text-capitalize"><?php echo e($item['year']); ?> <span class="visually-hidden" data-i18n="<?php echo e($item['visually_hidden_key']); ?>"><?php echo e(__($item['visually_hidden_key'])); ?></span></h3>
                        <p class="caption-text text-line-2 mb-0" data-i18n="<?php echo e($item['subtitle_key']); ?>"><?php echo e(__($item['subtitle_key'])); ?></p>
                    </header>
                    <p data-i18n="<?php echo e($item['text_key']); ?>"><?php echo e(__($item['text_key'])); ?></p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section-content" aria-labelledby="vision-mission-title">
        <h2 id="vision-mission-title" class="visually-hidden" data-i18n="about_18"><?php echo e(__('about_18')); ?></h2>
        <div class="section-header">
            <div class="container">
                <img src="<?php echo e(asset('images/about-vision-mission-sketch.png')); ?>" alt="background visi misi INDRACO" loading="lazy" class="w-100 h-auto">
            </div>
        </div>
        <div class="section-body">
            <div class="container">
                <div class="section-caption mb-5">
                    <header class="d-flex gap-3 align-items-center mb-3">
                        <h3 class="caption-title mb-0 display-2 fw-bold text-capitalize" data-i18n="about_19"><?php echo e(__('about_19')); ?></h3>
                    </header>
                    <p data-i18n="about_20"><?php echo e(__('about_20')); ?></p>
                </div>
                <div class="section-caption">
                    <header class="d-flex gap-3 align-items-center mb-3">
                        <h3 class="caption-title mb-0 display-2 fw-bold text-capitalize" data-i18n="about_21"><?php echo e(__('about_21')); ?></h3>
                    </header>
                    <p data-i18n="about_22"><?php echo e(__('about_22')); ?></p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section-content" aria-labelledby="value-title">
        <div class="section-header">
            <div class="container">
                <img src="<?php echo e(asset('images/about-value-sketch.png')); ?>" alt="background nilai-nilai INDRACO" loading="lazy" class="w-100 h-auto">
            </div>
        </div>
        <div class="section-body">
            <div class="container">
                <div class="row row-cols-1 row-gap-5">
                    <div class="col">
                        <div class="section-caption">
                            <header class="d-flex gap-3 align-items-center mb-3">
                                <h2 id="value-title" class="caption-title mb-0 display-2 fw-bold text-capitalize" data-i18n="about_23"><?php echo e(__('about_23')); ?></h2>
                            </header>
                        </div>
                    </div>
                    <div class="col">
                            ...
                            <li class="col">
                                <article class="d-flex gap-4 align-items-start">
                                    <div class="ratio ratio-1x1 w-25">
                                        <img src="<?php echo e(asset('images/about-customer-focus.png')); ?>" data-light="images/about-customer-focus.png" data-dark="images/about-customer-focus-invert.png" alt="" class="object-fit-contain theme-image" aria-hidden="true">
                                    </div>
                                    <div class="w-75">
                                        <h3 class="fs-5 fw-bold text-uppercase" data-i18n="about_25"><?php echo e(__('about_25')); ?></h3>
                                        <p class="small" data-i18n="about_26"><?php echo e(__('about_26')); ?></p>
                                    </div>
                                </article>
                            </li>
                            <li class="col">
                                <article class="d-flex gap-4 align-items-start">
                                    <div class="ratio ratio-1x1 w-25">
                                        <img src="<?php echo e(asset('images/about-teamwork.png')); ?>" data-light="images/about-teamwork.png" data-dark="images/about-teamwork-invert.png" alt="" class="object-fit-contain theme-image" aria-hidden="true">
                                    </div>
                                    <div class="w-75">
                                        <h3 class="fs-5 fw-bold text-uppercase" data-i18n="about_27"><?php echo e(__('about_27')); ?></h3>
                                        <p class="small" data-i18n="about_28"><?php echo e(__('about_28')); ?></p>
                                    </div>
                                </article>
                            </li>
                            <li class="col">
                                <article class="d-flex gap-4 align-items-start">
                                    <div class="ratio ratio-1x1 w-25">
                                        <img src="<?php echo e(asset('images/about-innovation.png')); ?>" data-light="images/about-innovation.png" data-dark="images/about-innovation-invert.png" alt="" class="object-fit-contain theme-image" aria-hidden="true">
                                    </div>
                                    <div class="w-75">
                                        <h3 class="fs-5 fw-bold text-uppercase" data-i18n="about_29"><?php echo e(__('about_29')); ?></h3>
                                        <p class="small" data-i18n="about_30"><?php echo e(__('about_30')); ?></p>
                                    </div>
                                </article>
                            </li>
                            <li class="col">
                                <article class="d-flex gap-4 align-items-start">
                                    <div class="ratio ratio-1x1 w-25">
                                        <img src="<?php echo e(asset('images/about-integrity.png')); ?>" data-light="images/about-integrity.png" data-dark="images/about-integrity-invert.png" alt="" class="object-fit-contain theme-image" aria-hidden="true">
                                    </div>
                                    <div class="w-75">
                                        <h3 class="fs-5 fw-bold text-uppercase" data-i18n="about_31"><?php echo e(__('about_31')); ?></h3>
                                        <p class="small" data-i18n="about_32"><?php echo e(__('about_32')); ?></p>
                                    </div>
                                </article>
                            </li>
                            <li class="col">
                                <article class="d-flex gap-4 align-items-start">
                                    <div class="ratio ratio-1x1 w-25">
                                        <img src="<?php echo e(asset('images/about-resources.png')); ?>" data-light="images/about-resources.png" data-dark="images/about-resources-invert.png" alt="" class="object-fit-contain theme-image" aria-hidden="true">
                                    </div>
                                    <div class="w-75">
                                        <h3 class="fs-5 fw-bold text-uppercase" data-i18n="about_33"><?php echo e(__('about_33')); ?></h3>
                                        <p class="small" data-i18n="about_34"><?php echo e(__('about_34')); ?></p>
                                    </div>
                                </article>
                            </li>
                        </ul>
    ...
    <section class="section-content" aria-labelledby="factory-title">
        <div class="section-header">
            <div class="container">
                <img src="<?php echo e(asset('images/about-factory-sketch.png')); ?>" alt="background pabrik INDRACO" loading="lazy" class="w-100 h-auto">
            </div>
        </div>
        <div class="section-body">
            <div class="container">
                <div class="row row-cols-1 row-gap-5">
                    <div class="col">
                        <div class="section-caption">
                            <header class="d-flex gap-3 align-items-center mb-3">
                                <h2 id="factory-title" class="caption-title mb-0 display-2 fw-bold text-capitalize" data-i18n="about_35"><?php echo e(__('about_35')); ?></h2>
                            </header>
                        </div>
                    </div>
                    <div class="col">
                        <ul class="list-unstyled factory-list row row-cols-1 row-gap-5">
                            <li class="col factory-item">
                                <article class="d-flex flex-column gap-3 flex-md-row align-items-md-center column-gap-md-5">
                                    <div class="factory-header ratio ratio-16x9 order-md-2">
                                        <img src="<?php echo e(asset('images/factory-bambe.jpg')); ?>" alt="Pabrik INDRACO Bambe, Gresik" loading="lazy" class="object-fit-cover">
                                    </div>
                                    <div class="factory-body order-md-1">
                                        ...
                                        <a href="https://maps.app.goo.gl/vLD5kH5WLryYcZwy6" target="_blank" rel="noopener" class="text-capitalize text-reset opacity-75-hover" aria-label="Lihat lokasi Pabrik Bambe di peta">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16"><path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10m0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6"/></svg> <span data-i18n="antar_saya_kesana"><?php echo e(__('antar_saya_kesana')); ?></span>
                                        </a>
                                    </div>
                                </article>
                            </li>
                            <li class="col factory-item ms-md-auto">
                                <article class="d-flex flex-column gap-3 flex-md-row align-items-md-center column-gap-md-5">
                                    <div class="factory-header ratio ratio-16x9 order-md-2">
                                        <img src="<?php echo e(asset('images/factory-dumai.jpg')); ?>" alt="Pabrik INDRACO Dumai" loading="lazy" class="object-fit-cover">
                                    </div>
                                    <div class="factory-body order-md-1">
                                        <h3 class="fs-5 fw-bold text-uppercase mb-2">PT. Indraco Global Indonesia</h3>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u1313327/public_html/beta.indracocoffee.com/resources/views/pages/about.blade.php ENDPATH**/ ?>