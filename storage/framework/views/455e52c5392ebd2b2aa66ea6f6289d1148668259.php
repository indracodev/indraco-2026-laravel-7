...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin Panel - INDRACO'); ?></title>
...
<body>
    <div class="d-flex">
            ...
            <ul class="nav flex-column">
                ...
                <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($menu->type == 'header'): ?>
                        <?php if(count($menu->children_list) > 0): ?>
                            <?php
                                $isActive = false;
                            ...
                            <li class="nav-item mt-2">
                                <a class="nav-link rounded px-3 py-2 mb-1 d-flex justify-content-between align-items-center <?php echo e($isActive ? '' : 'collapsed'); ?>" data-bs-toggle="collapse" href="#menu-<?php echo e($menu->id); ?>" style="cursor: pointer; color: #ced4da;">
                                    <div class="text-uppercase fw-bold" style="font-size: 0.85rem;">
                                        <?php if($menu->icon): ?> <i class="<?php echo e($menu->icon); ?> me-2"></i> <?php endif; ?>
                                        <?php echo e($menu->title); ?>

                                    </div>
                                    <i class="bi bi-chevron-down small"></i>
                                </a>
                                <div class="collapse <?php echo e($isActive ? 'show' : ''); ?>" id="menu-<?php echo e($menu->id); ?>">
                                    <ul class="nav flex-column ms-3">
                                        <?php $__currentLoopData = $menu->children_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="nav-item">
                                                <a class="nav-link rounded px-3 py-2 mb-2 <?php echo e(request()->is(trim($child->url, '/').'*') ? 'active' : ''); ?>" href="<?php echo e(url($child->url ?? '#')); ?>">
                                                    <?php if($child->icon): ?> <i class="<?php echo e($child->icon); ?> me-2"></i> <?php endif; ?>
                        ...
                        <?php else: ?>
                            <li class="sidebar-header"><?php echo e($menu->title); ?></li>
                        <?php endif; ?>
                    <?php else: ?>
                        <?php if(count($menu->children_list) > 0): ?>
                            <?php
                            ...
                            ?>
                            <li class="nav-item">
                                <a class="nav-link rounded px-3 py-2 mb-2 d-flex justify-content-between align-items-center <?php echo e($isActive ? '' : 'collapsed'); ?>" data-bs-toggle="collapse" href="#menu-<?php echo e($menu->id); ?>">
                                    <div>
                                        <?php if($menu->icon): ?> <i class="<?php echo e($menu->icon); ?> me-2"></i> <?php endif; ?>
                                        <?php echo e($menu->title); ?>
                        ...
                        <?php else: ?>
                            <li class="nav-item">
                                <a class="nav-link rounded px-3 py-2 mb-2 <?php echo e(request()->is(trim($menu->url, '/').'*') && $menu->url != '/' ? 'active' : ''); ?>" href="<?php echo e(url($menu->url ?? '#')); ?>" <?php echo $menu->url == '/' ? 'target="_blank"' : ''; ?>>
                                    <?php if($menu->icon): ?> <i class="<?php echo e($menu->icon); ?> me-2"></i> <?php endif; ?>
                                    <?php echo e($menu->title); ?>
                ...
                <li class="nav-item mt-4">
                    <form action="<?php echo e(route('admin.logout')); ?>" method="POST" class="d-inline w-100">
                        <?php echo csrf_field(); ?>
        ...
        <div class="flex-grow-1 <?php echo $__env->yieldContent('content_class', 'p-4'); ?>" style="<?php echo $__env->yieldContent('content_style', ''); ?> min-width:0; overflow:hidden;">
            <div class="d-flex justify-content-between align-items-center mb-4 pb-2 border-bottom <?php echo $__env->yieldContent('header_class', ''); ?>">
                <h2 class="h4 mb-0"><?php echo $__env->yieldContent('page_title', 'Dashboard'); ?></h2>
                <div>
                    <?php if(session('original_user_id')): ?>
                        <a href="<?php echo e(route('admin.users.impersonate.leave')); ?>" class="btn btn-sm btn-warning me-3">Kembali ke Akun Asli</a>
                    <?php endif; ?>
                    <span class="me-3">Halo, <strong><?php echo e(auth()->user()->name); ?></strong> (<?php echo e(auth()->user()->role); ?>)</span>
                    <form action="<?php echo e(url('admin/logout')); ?>" method="POST" class="d-inline">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH /home/u1313327/public_html/beta.indracocoffee.com/resources/views/layouts/admin.blade.php ENDPATH**/ ?>