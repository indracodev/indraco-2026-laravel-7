   ...
   <div class="modal-dialog modal-fullscreen-lg-down modal-dialog-scrollable">
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form role="search" action="<?php echo e(route('products.show', ['slug' => 'tugu-buaya'])); ?>" method="GET">
               <div class="mb-3">
...
<?php /**PATH /home/u1313327/public_html/beta.indracocoffee.com/resources/views/partials/modal_search.blade.php ENDPATH**/ ?>