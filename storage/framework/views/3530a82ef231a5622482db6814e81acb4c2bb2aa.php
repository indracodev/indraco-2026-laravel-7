<?php $__env->startSection('title', 'Manajemen Bahasa & Teks Halaman - Admin Panel'); ?>
<?php $__env->startSection('page_title', 'Manajemen Teks (Bahasa)'); ?>
<?php $__env->startSection('content_class', 'p-0'); ?>
<?php $__env->startSection('content_style', 'display:flex; flex-direction:column; height:calc(100vh - 0px);'); ?>
<?php $__env->startSection('header_class', 'px-4 pt-3'); ?>
...
<div class="translations-layout flex-grow-1" style="display: flex; overflow: hidden; margin-top: 0;">
    ...
    <div id="editorPanel" class="border-end bg-white d-flex flex-column" style="width: 380px; min-width: 280px; max-width: 500px; flex-shrink: 0; overflow: hidden;">
        ...
        <div class="flex-grow-1 overflow-auto">
            <form action="<?php echo e(url('admin/translations')); ?>" method="POST" id="translationForm">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>

                <div class="accordion accordion-flush" id="translationAccordion">
                    <?php $__currentLoopData = $groupedTranslations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupKey => $translations): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="accordion-item border-0 border-bottom">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed py-2 px-3 small" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-<?php echo e($groupKey); ?>">
                                <span class="fw-bold"><?php echo e($groupLabels[$groupKey] ?? ucfirst($groupKey)); ?></span>
                                <span class="badge bg-secondary ms-2" style="font-size: 0.6rem;"><?php echo e(count($translations)); ?></span>
                            </button>
                        </h2>
                        <div id="collapse-<?php echo e($groupKey); ?>" class="accordion-collapse collapse" data-bs-parent="#translationAccordion">
                            <div class="accordion-body p-0">
                                <table class="table table-sm mb-0">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $translations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $texts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="translation-row" data-key="<?php echo e($key); ?>">
                                            <td class="ps-3 align-top py-1">
                                                <code class="edit-key-trigger" data-key="<?php echo e($key); ?>" style="font-size: 0.6rem; word-break: break-all; cursor: pointer; color: #0d6efd; text-decoration: underline dotted;"><?php echo e($key); ?></code>
                                            </td>
                                            <td class="py-1">
                                                <textarea name="translations[<?php echo e($key); ?>][id]" class="form-control form-control-sm trans-input p-1" rows="1" data-key="<?php echo e($key); ?>" data-lang="id" style="font-size: 0.75rem;"><?php echo e($texts['id']); ?></textarea>
                                            </td>
                                            <td class="py-1 pe-2">
                                                <textarea name="translations[<?php echo e($key); ?>][en]" class="form-control form-control-sm trans-input p-1" rows="1" data-key="<?php echo e($key); ?>" data-lang="en" style="font-size: 0.75rem;"><?php echo e($texts['en']); ?></textarea>
                                            </td>
                                        </tr>
                ...
                <div class="iframe-scaler-wrap flex-grow-1 overflow-hidden d-flex justify-content-center bg-secondary bg-opacity-10 p-2">
                    <div class="iframe-scaler" style="transform-origin: top center; width: 1280px;">
                        <iframe class="preview-iframe" data-panel="id"
                            src="<?php echo e(url('/')); ?>?preview=1&preview_locale=id"
                ...
                <div class="iframe-scaler-wrap flex-grow-1 overflow-hidden d-flex justify-content-center bg-secondary bg-opacity-10 p-2">
                    <div class="iframe-scaler" style="transform-origin: top center; width: 1280px;">
                        <iframe class="preview-iframe" data-panel="en"
                            src="<?php echo e(url('/')); ?>?preview=1&preview_locale=en"
                            style="width: 1280px; height: 100vh; border: 0; display: block;"></iframe>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u1313327/public_html/beta.indracocoffee.com/resources/views/admin/translations/index.blade.php ENDPATH**/ ?>